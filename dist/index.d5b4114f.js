...
var _baddiePng = require("./res/Images/baddie.png");
var _baddiePngDefault = parcelHelpers.interopDefault(_baddiePng);
...
const textures = {
    ...
    buddie: new (0, _textureDefault.default)((0, _baddiePngDefault.default))
};
...
function spwanBuddie(x, y, speed) {
    const buddie = new (0, _spriteDefault.default)(textures.buddie);
    buddie.pos.x = x;
    buddie.pos.y = y;
    buddie.update = (dt, t)=>{
        buddie.pos.x += speed * dt;
        if (buddie.pos.x < -32) buddie.dead = true;
    };
    buddies.add(buddie);
}
function doGameOver() {
...
function loop(ellapsedTime) {
    ...
    buddies.children.forEach((baddie)=>{
...
},{"./pop/index":"5XN6z","./pop/Sprite":"id45o","./pop/Texture":"5U9tx","./res/Images/spaceship.png":"jJePl","./res/Images/bg.png":"My65e","./res/Images/bullet.png":"j38EM","./res/Images/baddie.png":"h4nea","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"5XN6z":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
exports.default = {
    ...
    Texture: (0, _textureDefault.default),
...
class Container {
   ...
   */ update(dt, t) {
        this.children = this.children.filter((child)=>{
            if (child.update) child.update(dt, t, this);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"5U9tx":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
class Texture {
    constructor(url){
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"id45o":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
class Sprite {
    update = (delta, t, self)=>{};
...
},{"14bc81e993d41fcb":"lgJ39"}],"h4nea":[function(require,module,exports) {
module.exports = require("b06d2e52da5c642d").getBundleURL("jpFg7") + "baddie.a8009b42.png" + "?" + Date.now();

},{"b06d2e52da5c642d":"lgJ39"}]},["1nhj6","2iQTb"], "2iQTb", "parcelRequiref9ae")
