...
const rect1 = new (0, _shapes.Rect)(0, 0, 40, 40, "green");
const rect2 = new (0, _shapes.Rect)(width - 40, 0, 40, 40, "red");
let dt = 0;
let lastTimeStamp = 0;
...
function update(dt, ellapsedTime) {
    /**
...
function isCollide(obj1, obj2) {
    ...
    if (obj1Left < obj2Right && obj1Right > obj2Left && obj1Top < obj2Bottom && obj1Bottom > obj2Top) return true;
    return false;
}
function render() {
...
},{"./Shapes":"lVNfc"}],"lVNfc":[function(require,module,exports) {
...
class Rect {
    ...
    width = 40;
    height = 40;
    constructor(x, y, width = 40, height = 40, fill){
        this.pos.x = x;
        this.pos.y = y;
        this.width = width;
        this.height = height;
